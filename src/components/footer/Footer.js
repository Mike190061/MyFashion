  ...
  return (
    <div className="footer">
          ...
          <Row justify="center" gutter={30}>
            <Col className="gutter-row" span="24" sm={12} lg={8}>
              <div className="footer-top-item -col-one">
                <Link href="#">
                  <a>
                    <img src={process.env.PUBLIC_URL + "/assets/images/logo2.png"} alt="Logo" />
                  </a>
                </Link>
                <p>Kawasan Sains Teknologi Padjadjaran, Jatinangor, Sumedang 45363</p>
                <ul>
                  <li>smarter@padjadjarantech.com</li>
                  <li>+62 856 2475 1258</li>
                </ul>
              </div>
            </Col>
            <Col className="gutter-row" span="24" sm={12} lg={8}>
            ...
            <Col className="gutter-row" span="24" sm={18} lg={8}>
              <div className="footer-top-item -col-three">
                ...
                <img src={process.env.PUBLIC_URL + "/assets/images/footer/payment.png"} alt="Payment methods" />
              </div>
            </Col>
          </Row>
        </Container>
      ...
      <div className="footer-bottom">
        <Container type={containerType}>
          <p>Copyright © 2021 Padjadjaran Technology. All rights reserved</p>
        </Container>
      </div>
    </div>
  );
